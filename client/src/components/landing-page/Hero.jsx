    ...
    <section className="bg-secondary-pink h-screen w-screen pl-10 lg:pl-20 pt-28 lg:pt-60 relative">
      ...
      <div className="z-10 relative mr-20 lg:mr-0">
        ...
        <p className="text-xl sm:text-2xl w-full lg:w-1/2 leading-8 sm:leading-9 text-primary-black">
          ...
          <span className="text-primary-pink">gratuites</span>, pour le bien-être de votre compagnon.
        </p>
        <div className="mt-8 max-w-3xl bg-white rounded-2xl p-8 border-2 border-transparent">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            >
              <div className="bg-gradient-to-br shadow-md from-primary-pink/10 to-primary-blue/10 rounded-2xl p-6 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 group">
                <img 
                  src={dogowner} 
                  alt="Illustration d'un propriétaire de chien ayant besoin d'aide pour promener son animal"
                  className="w-32 h-32 mx-auto mb-4 object-contain"
                />
                <h3 className="text-xl font-bold text-primary-black text-center mb-2 group-hover:text-primary-pink transition-colors">
